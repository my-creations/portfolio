...
describe('translations.js', () => {
  ...
  describe('translations object', () => {
    ...
    it('should have all 15 projects in English', () => {
      const projectKeys = Object.keys(translations.en.projects).filter(
        (k) => k.startsWith('project')
      )
      expect(projectKeys).toHaveLength(15)
    })

    it('should have all 15 projects in Portuguese', () => {
      const projectKeys = Object.keys(translations.pt.projects).filter(
        (k) => k.startsWith('project')
      )
      expect(projectKeys).toHaveLength(15)
    })
