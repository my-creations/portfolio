  ...
  en: {
    ...
    projects: {
      ...
      projectCufPrepara: {
        title: 'CUF Prepara',
        description:
          'A pre-colonoscopy preparation guide for Hospital CUF Descobertas, with clear step-by-step instructions and timeline',
        github: 'GitHub',
        liveDemo: 'Live Demo',
      },
      projectDoseSegura: {
        title: 'Dose Segura',
        description:
          'A quick-reference nursing app focused on safe dosage guidance and faster clinical decision support',
        github: 'GitHub',
        liveDemo: 'Live Demo',
      },
      projectVestaboard: {
      ...
      projectTwelve: {
        title: 'NASA APOD',
        description:
          "Explore NASA's Astronomy Picture of the Day with this interactive application featuring space imagery",
        github: 'GitHub',
        liveDemo: 'Live Demo',
      },
      projectThirteen: {
        ...
        description:
          'A fast-paced mathematical quiz game to test and improve your arithmetic skills under time pressure',
        github: 'GitHub',
        liveDemo: 'Live Demo',
      },
      projectFourteen: {
        title: 'Drag and Drop',
        description:
          'An interactive drag-and-drop application demonstrating HTML5 drag events and dynamic UI interactions',
        github: 'GitHub',
        liveDemo: 'Live Demo',
      },
      projectFifteen: {
    ...
    contact: { sectionTitle: 'Contact Me', email: 'pmrobalo@gmail.com', linkedin: 'LinkedIn', github: 'GitHub' },
  ...
  pt: {
    ...
    projects: {
      ...
      projectCufPrepara: {
        title: 'CUF Prepara',
        description:
          'Guia de preparação para colonoscopia no Hospital CUF Descobertas, com instruções passo a passo e cronologia clara',
        github: 'GitHub',
      ...
      projectTen: {
        title: 'Form Validator',
        description:
          'Uma aplicação de validação de formulários do lado do cliente com feedback em tempo real e sanitização de entrada',
        github: 'GitHub',
        liveDemo: 'Demo Ao Vivo',
      },
      projectEleven: {
      ...
      projectThirteen: {
        title: 'Math Sprint Game',
        description:
          'Um jogo de quiz matemático rápido para testar e melhorar as tuas habilidades aritméticas sob pressão de tempo',
        github: 'GitHub',
        liveDemo: 'Demo Ao Vivo',
      },
      projectFourteen: {
        title: 'Drag and Drop',
        description:
          'Uma aplicação interativa de arrastar e soltar demonstrando eventos HTML5 de arrastar e interações dinâmicas de UI',
        github: 'GitHub',
        liveDemo: 'Demo Ao Vivo',
      },
      projectFifteen: {
    ...
    contact: { sectionTitle: 'Contacta-me', email: 'pmrobalo@gmail.com', linkedin: 'LinkedIn', github: 'GitHub' },
